...
| `worlo-teams-mac.zip` | macOS — native Electron app (worlo W in Dock). **Only on [GitHub Releases](https://github.com/aethercous/flowix/releases/latest)** (~90 MB universal). |
